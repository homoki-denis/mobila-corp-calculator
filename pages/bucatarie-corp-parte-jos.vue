<template>
  <div class="flex items-center justify-center flex-wrap min-h-90">
    <form class="bg-white p-8 rounded shadow-md w-full max-w-md mx-4 mb-4">
    ...
    <div
      ...
      class="bg-white text-black px-8 py-12 rounded shadow-md w-full max-w-md mx-4 mb-4"
    >
      <p class="text-gray-700">
        Dimensiuni laterale: lungime
